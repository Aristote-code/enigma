...
Data Table is a pattern component and is not exposed as a Enigma component. It is built on top of [Table](../components/table) and [TanStack Table](https://tanstack.com/table).
...
As you can see from the above example, Data Table’s composition is heavily dependent on use case. We do not yet have a shared Enigma component for this reason.
...
Data Grid is a pattern component and is not exposed as a Enigma component. It is based on [React Data Grid](https://comcast.github.io/react-data-grid/#/CommonFeatures) and originally adopted for areas including Studio’s Table Editor, Query Performance, and other high-interaction surfaces.
